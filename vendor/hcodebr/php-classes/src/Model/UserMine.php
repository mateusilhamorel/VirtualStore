    ...
    public static function checkLogin($inadmin = true)
    {
          ...
          !(int)$_SESSION[User::SESSION]["iduser"]>0)
        {
           ...
           return false;
            ...
            if($inadmin === true &&  (bool)$_SESSION[User::SESSION]['inamin'] === true)
            {
                return true;
    ...
    public static function getForgot($email, $inadmin = true)
    {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if ($inadmin === true) 
                    {
                        $link = "http://virtualstore/admin/forgot/reset?code=$code";
                    } 
                    else 
                    {
                        $link = "http://virtualstore/forgot/reset?code=$code";
                    }		
                    $mailer = new Mailer($data['desemail'], $data['desperson'], "Redefinir senha Virtual Store", "forgot", 
                                        array(
                                             "name"=>$data['desperson'],
                                             "link"=>$link
                                             ));				
